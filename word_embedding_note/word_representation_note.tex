...
\begin{abstract}
最近几年词向量表示引起了工业界蛮大的关注，其中最大原因当属2013年mikolov放出的word2vec工具包。本Note对几种常见的词向量表示方法(包括\textbf{word-context matrix} , \textbf{Skip-Gram with Negative sampling}和 \textbf{Glove})进行了较详细的解释，希望能对新接触这一领域的同学有所帮助。 
\end{abstract}
...
\subsection{SGNS and PPMI}
\subsection{SGNS and Glove}
